...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.MyViewHolder> {
    ...
    DataAdapter(MainActivity activity, ArrayList<String> mBlogTitleList, ArrayList<String> mAuthorNameList, ArrayList<String> mBlogUploadDateList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        System.out.println("Emon onCreateViewHolder pass");
